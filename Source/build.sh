...
# Build emscripten
if [ $BUILD_EM ]; then
    EM_ARTK_FLAGS="-msse -msse2 -msse3 -mssse3 -I$OURDIR/depends/emscripten/opencv-4.1 -I$OURDIR/depends/emscripten/opencv-4.1/modules/core/include -I$OURDIR/depends/emscripten/opencv-4.1/modules/highgui/include -I$OURDIR/depends/emscripten/opencv-4.1/modules/imgcodecs/include -I$OURDIR/depends/emscripten/opencv-4.1/modules/videoio/include -I$OURDIR/depends/emscripten/opencv-4.1/modules/imgproc/include -I$OURDIR/depends/emscripten/opencv-4.1/modules/calib3d/include -I$OURDIR/depends/emscripten/opencv-4.1/modules/features2d/include -I$OURDIR/depends/emscripten/opencv-4.1/modules/flann/include -I$OURDIR/depends/emscripten/opencv-4.1/modules/video/include -I$OURDIR/ARX/OCVT/include"
