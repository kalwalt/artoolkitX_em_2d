...
if [ $BUILD_EM ]; then
    ...
    EM_ARTK_FLAGS="-msse -msse2 -msse3 -mssse3 -I$OURDIR/depends/emscripten/opencv-em -I$OURDIR/depends/emscripten/opencv-em/modules/core/include -I$OURDIR/depends/emscripten/opencv-em/modules/core/include -I$OURDIR/depends/emscripten/opencv-em/modules/highgui/include -I$OURDIR/depends/emscripten/opencv-em/modules/imgcodecs/include -I$OURDIR/depends/emscripten/opencv-em/modules/videoio/include -I$OURDIR/depends/emscripten/opencv-em/modules/imgproc/include -I$OURDIR/depends/emscripten/opencv-em/modules/calib3d/include -I$OURDIR/depends/emscripten/opencv-em/modules/features2d/include -I$OURDIR/depends/emscripten/opencv-em/modules/flann/include -I$OURDIR/depends/emscripten/opencv-em/modules/video/include -I$OURDIR/ARX/OCVT/include"
    cd $OURDIR
