...
if [ $BUILD_EM ]; then
    ...
    cd build-em
    rm -f CMakeCache.txt
    emcmake cmake .. -DCMAKE_BUILD_TYPE=${DEBUG+Debug}${DEBUG-Release} -DCMAKE_CXX_FLAGS="-s USE_LIBJPEG=1" -DCMAKE_C_FLAGS="-s USE_LIBJPEG=1" -DCMAKE_C_FLAGS_RELEASE="-DNDEBUG -O3" -DCMAKE_CXX_FLAGS_RELEASE="-DNDEBUG -O3"
